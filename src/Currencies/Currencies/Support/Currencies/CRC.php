 ...
 * Costa Rican Colón
 */
final class CRC extends AbstractCurrency implements CurrencyInterface
{
    public function __construct()
    {
        $this->setName(CurrencyName::CRC);
        $this->setCode(CurrencyCode::CRC);
        $this->setSymbol('₡');
        $this->setFlag(CurrencyFlag::CRC);
