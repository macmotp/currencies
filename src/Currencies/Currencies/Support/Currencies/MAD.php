 ...
 * Moroccan Dirham
 */
final class MAD extends AbstractCurrency implements CurrencyInterface
{
    public function __construct()
    {
        $this->setName(CurrencyName::MAD);
        $this->setCode(CurrencyCode::MAD);
        $this->setSymbol('DH');
        $this->setFlag(CurrencyFlag::MAD);
