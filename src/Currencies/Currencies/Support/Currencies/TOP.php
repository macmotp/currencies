 ...
 * Tongan Pa'anga
 */
final class TOP extends AbstractCurrency implements CurrencyInterface
{
    public function __construct()
    {
        $this->setName(CurrencyName::TOP);
        $this->setCode(CurrencyCode::TOP);
        $this->setSymbol('T$');
        $this->setFlag(CurrencyFlag::TOP);
