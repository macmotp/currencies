 ...
 * Romanian Leu
 */
final class RON extends AbstractCurrency implements CurrencyInterface
{
    public function __construct()
    {
        $this->setName(CurrencyName::RON);
        $this->setCode(CurrencyCode::RON);
        $this->setSymbol('lei');
        $this->setFlag(CurrencyFlag::RON);
