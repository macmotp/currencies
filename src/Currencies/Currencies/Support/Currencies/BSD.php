 ...
 * Bahamian Dollar
 */
final class BSD extends AbstractCurrency implements CurrencyInterface
{
    public function __construct()
    {
        $this->setName(CurrencyName::BSD);
        $this->setCode(CurrencyCode::BSD);
        $this->setSymbol('B$');
        $this->setFlag(CurrencyFlag::BSD);
