 ...
 * South African Rand
 */
final class ZAR extends AbstractCurrency implements CurrencyInterface
{
    public function __construct()
    {
        $this->setName(CurrencyName::ZAR);
        $this->setCode(CurrencyCode::ZAR);
        $this->setSymbol('R');
        $this->setFlag(CurrencyFlag::ZAR);
