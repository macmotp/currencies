 ...
 * Albanian Lek
 */
final class ALL extends AbstractCurrency implements CurrencyInterface
{
    public function __construct()
    {
        $this->setName(CurrencyName::ALL);
        $this->setCode(CurrencyCode::ALL);
        $this->setSymbol('L');
        $this->setFlag(CurrencyFlag::ALL);
