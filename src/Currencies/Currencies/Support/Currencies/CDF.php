 ...
 * Congolese Franc
 */
final class CDF extends AbstractCurrency implements CurrencyInterface
{
    public function __construct()
    {
        $this->setName(CurrencyName::CDF);
        $this->setCode(CurrencyCode::CDF);
        $this->setSymbol('FC');
        $this->setFlag(CurrencyFlag::CDF);
