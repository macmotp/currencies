 ...
 * Bulgarian Lev
 */
final class BGN extends AbstractCurrency implements CurrencyInterface
{
    public function __construct()
    {
        $this->setName(CurrencyName::BGN);
        $this->setCode(CurrencyCode::BGN);
        $this->setSymbol('лв');
        $this->setFlag(CurrencyFlag::BGN);
