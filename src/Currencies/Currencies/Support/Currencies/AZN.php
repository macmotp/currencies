 ...
 * Azerbaijani Manat
 */
final class AZN extends AbstractCurrency implements CurrencyInterface
{
    public function __construct()
    {
        $this->setName(CurrencyName::AZN);
        $this->setCode(CurrencyCode::AZN);
        $this->setSymbol('₼');
        $this->setFlag(CurrencyFlag::AZN);
