 ...
 * Danish Krone
 */
final class DKK extends AbstractCurrency implements CurrencyInterface
{
    public function __construct()
    {
        $this->setName(CurrencyName::DKK);
        $this->setCode(CurrencyCode::DKK);
        $this->setSymbol('kr.');
        $this->setFlag(CurrencyFlag::DKK);
