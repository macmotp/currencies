 ...
 * Peruvian Sol
 */
final class PEN extends AbstractCurrency implements CurrencyInterface
{
    public function __construct()
    {
        $this->setName(CurrencyName::PEN);
        $this->setCode(CurrencyCode::PEN);
        $this->setSymbol('S/');
        $this->setFlag(CurrencyFlag::PEN);
