 ...
 * Singapore Dollar
 */
final class SGD extends AbstractCurrency implements CurrencyInterface
{
    public function __construct()
    {
        $this->setName(CurrencyName::SGD);
        $this->setCode(CurrencyCode::SGD);
        $this->setSymbol('S$');
        $this->setFlag(CurrencyFlag::SGD);
