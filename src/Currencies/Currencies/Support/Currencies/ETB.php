 ...
 * Ethiopian Birr
 */
final class ETB extends AbstractCurrency implements CurrencyInterface
{
    public function __construct()
    {
        $this->setName(CurrencyName::ETB);
        $this->setCode(CurrencyCode::ETB);
        $this->setSymbol('Br');
        $this->setFlag(CurrencyFlag::ETB);
